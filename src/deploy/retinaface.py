  ...
  def detect(self, img, threshold=0.5, scales=[1.0], do_flip=False):
    ...
    for im_scale in scales:
      for flip in flips:
        ...
        # graph = mx.viz.plot_network(self.model.symbol)
        #
        ...
        for _idx,s in enumerate(self._feat_stride_fpn):
            ...
            # print(_key, "Score shape: ", scores.shape)
            # for k in range(9):
            #     temp = net_out[k].asnumpy()
            #     print(temp.shape)
            ...
            # print(_key, "bbox shape: ", bbox_deltas.shape)
            ...
            if not self.vote and self.use_landmarks:
              ...
              # print(_key, "landmark shape: ", landmark_deltas.shape)
              # print(landmark_deltas.shape)
